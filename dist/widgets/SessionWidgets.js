...
import { formatBytes, formatDurationCompact, getOptionNumber, getOptionString, getVariant, renderBadge, renderLabel, } from "./helpers.js";
...
export class SessionIdWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Session", "abc123", item, ctx);
...
export class VersionWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Version", "1.0.22", item, ctx);
...
export class OutputStyleWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Style", "default", item, ctx);
...
export class SessionElapsedWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Session", "42m 12s", item, ctx);
...
export class AccountEmailWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Account", "me@example.com", item, ctx);
...
export class ThinkingEffortWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Effort", "high", item, ctx);
...
export class VimModeWidget extends BaseWidget {
    ...
    render(item, ctx) {
        if (ctx.isPreview)
            return renderLabel("Vim", "insert", item, ctx);
...
export class LinkWidget extends BaseWidget {
    ...
    render(item, ctx) {
        ...
        if (ctx.isPreview)
            return hyperlink("docs", "https://example.com");
        if (!url)
            return text || null;
